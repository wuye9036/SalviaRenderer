...
quaternion operator/(const quaternion &lhs, const quaternion &rhs) { return lhs * inv(rhs); }

quaternion operator/(const quaternion &q, float scalar) { return q * (1.0f / scalar); }

...
template <EnumOrIntType EorI>
constexpr auto to_underlying_or_fwd(EorI v) noexcept {
...
template <EnumType E, EnumOrIntType EorI>
constexpr E operator|(E lhs, EorI rhs) noexcept {

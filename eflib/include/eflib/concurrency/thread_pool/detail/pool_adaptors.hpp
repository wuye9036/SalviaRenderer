 ...
 * member function. This a convenience shorthand for pool->schedule(bind(&Runnable::run,
 * task_object)). \param \param obj The Runnable object. The member function run() will be exectued
 * and should not throw execeptions. \return true, if the task could be scheduled and false
 * otherwise.
 */
...
typename enable_if<is_void<typename result_of<typename Pool::task_type()>::type>, bool>::type

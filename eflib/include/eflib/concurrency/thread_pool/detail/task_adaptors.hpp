...
public:
   ...
   */
  bool operator<(const prio_task_func& rhs) const { return m_priority < rhs.m_priority; }
...
public:
   ...
   * \param interval The minimum break time in milli seconds before the first execution of the task
   * function and between the following ones.
   */

...
namespace eflib {
namespace pool {
template <typename ObjectT, int MaxCount, bool IsFreeTogether = true> class stack_pool {
public:
...
template <typename ObjectT, int MaxCount> class stack_pool<ObjectT, MaxCount, true> {
private:

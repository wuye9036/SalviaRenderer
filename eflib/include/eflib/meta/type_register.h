...
#        define REGISTER_TYPE(r, dummy, i, type_elem)            \
          template <>                                            \
          struct type_encode<type_elem> {                        \
            static const int id = i;                             \
            static const ENUM_TYPE_NAME tag = ENUM_TYPE_NAME(i); \
          };                                                     \
          template <>                                            \
          struct type_decode<i> {                                \
...
enum ENUM_NAME { BOOST_PP_SEQ_FOR_EACH_I(REGISTER_ENUM_ITEM, _, DECL_REGISTERED_TYPES) };

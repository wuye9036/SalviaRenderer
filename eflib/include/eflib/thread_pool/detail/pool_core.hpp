        ...
        namespace detail
        {
            ...
            */
            ...
            private: // The following members are implemented thread-safe:
                ...
                mutable condition_variable_any m_worker_idle_or_terminated_event;	// A worker is idle or was terminated.
                mutable condition_variable_any m_task_or_terminate_workers_event;  // Task is available OR total worker count should be reduced.

...
char const* vs_code = "float4x4	wvpMatrix; \r\n"
                      "float4		lightPos0; \r\n"
                      "float4		lightPos1; \r\n"
                      "float4		lightPos2; \r\n"
                      "struct VSIn{ \r\n"
...
public:
  ...
  bool shader_prog(const vs_output& in, ps_output& out) {
    ...
    out.color[0] =
        clampss(vec4(0.7f, 0.1f, 0.3f, 1.0f) * refl0 * invLight0Distance * invLight0Distance +
...
public:
  ...
  void on_init() override {
    ...
    mesh_ = create_planar(data_->renderer.get(),
                          vec3(-3.0f, -1.0f, -3.0f),
                          vec3(6, 0.0f, 0.0f),
                          vec3(0.0f, 0.0f, 6),
                          1,
  ...
  void on_frame() override {
    ...
    switch (data_->mode) {
    case salvia::utility::app_modes::benchmark: camera_angle -= 0.01f; break;
    case salvia::utility::app_modes::test: camera_angle -= 0.55f; break;

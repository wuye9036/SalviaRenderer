...
protected:
  ...
  void on_frame() override {
    ...
    switch (data_->mode) {
    case app_modes::benchmark: scene_sec = static_cast<float>(data_->frame_count) * 0.015f; break;
    case app_modes::test: scene_sec = static_cast<float>(data_->frame_count) * 1.5f; break;

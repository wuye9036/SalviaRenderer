...
protected:
  void on_init() override {
...

    {
      ...
      box_tex = load_texture(data_->renderer.get(),
                             find_path(_EFLIB_T("texture_and_blending/Dirt.jpg")),
...

    {
      ...
      plane_tex = load_texture(data_->renderer.get(),
                               find_path(_EFLIB_T("texture_and_blending/chessboard.png")),
                               salviar::pixel_format_color_rgba8);

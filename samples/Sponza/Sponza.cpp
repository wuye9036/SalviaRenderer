...
char const* sponza_vs_code = "float4x4 wvpMatrix; \r\n"
                             "float4   eyePos; \r\n"
                             "float4	  lightPos; \r\n"
                             "struct VSIn{ \r\n"
                             "	float4 pos: POSITION; \r\n"
...
int const BENCHMARK_FRAME_COUNT = eflib::is_debug_mode ? 8 : 80;
int const TEST_FRAME_COUNT = 8;

class sponza : public sample_app {
public:
  sponza() : sample_app("Sponza") {}
...
#endif
    sponza_mesh =
        create_mesh_from_obj(data_->renderer.get(), find_path("sponza_lq/sponza.obj"), false);

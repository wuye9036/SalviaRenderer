...
protected:
  virtual void on_init() {
    ...
    astro_boy_mesh = create_mesh_from_collada(data_->renderer.get(),
                                              find_path("astro_boy/astroBoy_walk_Maya.dae"));
  ...
  void on_frame() override {
    ...
    // C++ vertex shader and SASL vertex shader are all available.
      ...
      data_->renderer->set_vs_variable_pointer(
          "boneMatrices", &boneMatrices[0], sizeof(mat44) * boneMatrices.size());
      data_->renderer->set_vs_variable_pointer(
          "invMatrices", &boneInvMatrices[0], sizeof(mat44) * boneInvMatrices.size());
#else

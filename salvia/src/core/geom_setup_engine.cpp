...
geom_setup_engine::geom_setup_engine()
    : ctxt_(nullptr), clipping_package_count_(0), clipped_verts_cap_(0),
      clipped_package_verts_count_cap_(0), clipped_package_compacted_addresses_cap_(0),
      compacted_verts_cap_(0), thread_count_(eflib::num_available_threads()) {}
...
void geom_setup_engine::clip_geometries() {
  ...
  for (size_t i = 0; i < thread_count_; ++i) {
    ...
    vso_pools_[i].reserve(
        ctxt_->prim_count * 4,
        16); // Two clipping plane. In extreme case, there are 4 verts generated by clipper.
  }

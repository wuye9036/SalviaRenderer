...
void clipper::clip_triangle_to_poly_general(vs_output **tri_verts, clip_results *results) const {
  ...
  if (in_frustum) {
    results->is_front =
        compute_front(tri_verts[0]->position(), tri_verts[1]->position(), tri_verts[2]->position());
...
void clipper::clip_triangle_to_poly_simple(vs_output **tri_verts, clip_results *results) const {
  ...
  // Quick test
  bool less_z[] = {tri_verts[0]->position().z() < -tri_verts[0]->position().w(),
  ...
  if (!need_clip) {
    bool greater_z[] = {tri_verts[0]->position().z() > tri_verts[0]->position().w(),
                        tri_verts[1]->position().z() > tri_verts[1]->position().w(),
                        tri_verts[2]->position().z() > tri_verts[2]->position().w()};
    ...
    bool less_x[] = {tri_verts[0]->position().x() < -tri_verts[0]->position().w(),
    ...
    bool greater_x[] = {tri_verts[0]->position().x() > tri_verts[0]->position().w(),
                        tri_verts[1]->position().x() > tri_verts[1]->position().w(),
                        tri_verts[2]->position().x() > tri_verts[2]->position().w()};
    ...
    bool less_y[] = {tri_verts[0]->position().y() < -tri_verts[0]->position().w(),
    ...
    bool greater_y[] = {tri_verts[0]->position().y() > tri_verts[0]->position().w(),
                        tri_verts[1]->position().y() > tri_verts[1]->position().w(),
                        tri_verts[2]->position().y() > tri_verts[2]->position().w()};

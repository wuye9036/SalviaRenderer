...
FIBITMAP* make_bitmap_copy(rect<size_t>& out_region,
                           size_t dest_width,
                           size_t dest_height,
                           FIBITMAP* image,
                           const rect<size_t>& src_region) {
  ...
  if (src_region.x == 0 && src_region.y == 0 && src_region.w == img_w && src_region.h == img_h) {
    ...
    sub_image = FreeImage_Copy(image,
                               (int)src_region.x,
                               (int)src_region.y,
                               (int)(src_region.x + src_region.w),
                               int(src_region.y + src_region.h));

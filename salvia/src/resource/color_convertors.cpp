...
template <int outColor, int inColor> struct color_convertor_initializer {
  ...
  color_convertor_initializer(pixel_format_convertor::pixel_convertor *pxcvt_table,
    ...
    pxacvt_table[inColor + outColor * pixel_type_to_fmt<color_max>::fmt] =
        &convert_array_t<typename pixel_fmt_to_type<outColor>::type,
                         typename pixel_fmt_to_type<inColor>::type>::op;
...
template <int outColor> struct color_convertor_initializer<outColor, 0> {
  ...
  color_convertor_initializer(pixel_format_convertor::pixel_convertor *pxcvt_table,
    ...
    pxacvt_table[outColor * pixel_type_to_fmt<color_max>::fmt] =
        &convert_array_t<typename pixel_fmt_to_type<outColor>::type,
                         pixel_fmt_to_type<0>::type>::op;
    pxlerp_1d_table[0] = &lerp_1d_t<pixel_fmt_to_type<0>::type>;
    pxlerp_2d_table[0] = &lerp_2d_t<pixel_fmt_to_type<0>::type>;
  }
};

pixel_format_convertor::pixel_convertor pixel_format_convertor::convertors[pixel_format_color_max]
                                                                          [pixel_format_color_max];
pixel_format_convertor::pixel_array_convertor
    pixel_format_convertor::array_convertors[pixel_format_color_max][pixel_format_color_max];

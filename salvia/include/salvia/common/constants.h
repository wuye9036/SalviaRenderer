...
enum map_result { map_succeed, map_failed, map_do_not_wait };
...
enum prim_type { pt_none, pt_point, pt_line, pt_solid_tri, pt_wireframe_tri };
...
// Usage describes the default component value will be filled to unfilled component if source data
// isn't a 4-components vector. Position means fill to (0, 0, 0, 1) Attrib means fill to (0,0,0,0)
...
enum clear_flag { clear_depth = 0x1, clear_stencil = 0x2 };
...
enum class async_status : uint32_t { error, timeout, ready };

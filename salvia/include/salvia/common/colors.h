...
/** R32BG32B32A32 u-norm float type.
 */
struct color_rgba32f {
  ...
  template <class T> color_rgba32f &operator=(const T &c) {
    *this = c.to_rgba32f();
    return *this;
  }

  eflib::vec4 *get_pointer() { return (eflib::vec4 *)this; }

  const eflib::vec4 *get_pointer() const { return (const eflib::vec4 *)this; }

  eflib::vec4 &get_vec4() { return (eflib::vec4 &)(*this); }

  const eflib::vec4 &get_vec4() const { return (const eflib::vec4 &)(*this); }
};
...
struct color_rgb32f {
  ...
  template <class T> color_rgb32f(const T &rhs) { *this = rhs; }
  ...
  color_rgb32f &operator=(const color_rgba32f &rhs) { return assign(rhs); }

  template <class T> color_rgb32f &operator=(const T &rhs) { return assign(rhs.to_rgba32f()); }

  color_rgba32f to_rgba32f() const { return color_rgba32f(r, g, b, 1.0f); }
...
struct color_r32f {
  ...
  template <class T> color_r32f(const T &rhs) { *this = rhs; }
  ...
  color_r32f &operator=(const color_rgba32f &rhs) { return assign(rhs); }

  template <class T> color_r32f &operator=(const T &rhs) { return assign(rhs.to_rgba32f()); }

  color_rgba32f to_rgba32f() const { return color_rgba32f(r, 0.0f, 0.0f, 0.0f); }
...
struct color_rg32f {
  ...
  template <class T> color_rg32f(const T &rhs) { *this = rhs; }
  ...
  color_rg32f &operator=(const color_rgba32f &rhs) { return assign(rhs); }

  template <class T> color_rg32f &operator=(const T &rhs) { return assign(rhs.to_rgba32f()); }

  color_rgba32f to_rgba32f() const { return color_rgba32f(r, g, 0.0f, 0.0f); }
...
struct color_rgba8 {
  ...
  template <class T> color_rgba8(const T &rhs) { *this = rhs; }
  ...
  color_rgba8 &operator=(const color_rgba32f &rhs) { return assign(rhs); }

  template <class T> color_rgba8 &operator=(const T &rhs) { return assign(rhs.to_rgba32f()); }
...
struct color_bgra8 {
  ...
  template <class T> color_bgra8(const T &rhs) { *this = rhs; }
  ...
  color_bgra8 &operator=(const color_rgba32f &rhs) { return assign(rhs); }

  template <class T> color_bgra8 &operator=(const T &rhs) { return assign(rhs.to_rgba32f()); }
...
struct color_r32i {
  ...
  template <class T> color_r32i(const T &rhs) { *this = rhs; }
  ...
  color_r32i &operator=(const color_rgba32f &rhs) { return assign(rhs); }

  template <class T> color_r32i &operator=(const T &rhs) { return assign(rhs.to_rgba32f()); }

  color_rgba32f to_rgba32f() const { return color_rgba32f(float(r), 0.0f, 0.0f, 0.0f); }
...
inline color_rgba32f lerp(const color_rgb32f &c0, const color_rgb32f &c1, float t) {
  return color_rgb32f(c0.r + (c1.r - c0.r) * t, c0.r + (c1.g - c0.g) * t, c0.r + (c1.b - c0.b) * t)
      .to_rgba32f();
}
inline color_rgba32f lerp(const color_bgra8 &c0, const color_bgra8 &c1, float t) {
  color_rgba32f ret =
      lerp(color_rgba32f(c0.r, c0.g, c0.b, c0.a), color_rgba32f(c1.r, c1.g, c1.b, c1.a), t);
  ret.get_vec4() /= 255.0f;
  return ret;
}
...
inline color_rgba32f lerp(const color_rgba32f &c0, const color_rgba32f &c1, const color_rgba32f &c2,
                          const color_rgba32f &c3, float tx, float ty) {
#ifndef EFLIB_NO_SIMD
  __m128 mc0 = _mm_loadu_ps(&c0.r);
  __m128 mc1 = _mm_loadu_ps(&c1.r);
...
inline color_rgba32f lerp(const color_rgb32f &c0, const color_rgb32f &c1, const color_rgb32f &c2,
                          const color_rgb32f &c3, float tx, float ty) {
  ...
  return color_rgb32f(c01.r + (c23.r - c01.r) * ty, c01.r + (c23.g - c01.g) * ty,
                      c01.r + (c23.b - c01.b) * ty)
      .to_rgba32f();
}
inline color_rgba32f lerp(const color_bgra8 &c0, const color_bgra8 &c1, const color_bgra8 &c2,
                          const color_bgra8 &c3, float tx, float ty) {
#ifndef EFLIB_NO_SIMD
...
#else
  color_rgba32f ret =
      lerp(color_rgba32f(c0.r, c0.g, c0.b, c0.a), color_rgba32f(c1.r, c1.g, c1.b, c1.a),
           color_rgba32f(c2.r, c2.g, c2.b, c2.a), color_rgba32f(c3.r, c3.g, c3.b, c3.a), tx, ty);
  ret.get_vec4() /= 255.0f;
  return ret;
#endif
}
inline color_rgba32f lerp(const color_rgba8 &c0, const color_rgba8 &c1, const color_rgba8 &c2,
                          const color_rgba8 &c3, float tx, float ty) {
#ifndef EFLIB_NO_SIMD
  __m128i mzero = _mm_setzero_si128();
  __m128i mci = _mm_cvtsi32_si128(*reinterpret_cast<const int *>(&c0.r));
  mci = _mm_unpacklo_epi8(mci, mzero);
...
inline color_rgba32f lerp(const color_r32f &c0, const color_r32f &c1, const color_r32f &c2,
                          const color_r32f &c3, float tx, float ty) {
  color_r32f c01(c0.r + (c1.r - c0.r) * tx);
  color_r32f c23(c2.r + (c3.r - c2.r) * tx);
  return color_r32f(c01.r + (c23.r - c01.r) * ty).to_rgba32f();
}
inline color_rgba32f lerp(const color_rg32f &c0, const color_rg32f &c1, const color_rg32f &c2,
                          const color_rg32f &c3, float tx, float ty) {
...
inline color_rgba32f lerp(const color_r32i &c0, const color_r32i &c1, const color_r32i &c2,
                          const color_r32i &c3, float tx, float ty) {
  color_r32f c01(c0.r + (c1.r - c0.r) * tx);
  color_r32f c23(c2.r + (c3.r - c2.r) * tx);
  return color_r32f(c01.r + (c23.r - c01.r) * ty).to_rgba32f();
}

...
inline color_rgba32f lerp(const color_rgba32f& c0,
                          const color_rgba32f& c1,
                          const color_rgba32f& c2,
                          const color_rgba32f& c3,
                          float tx,
                          float ty) {
#ifndef EFLIB_NO_SIMD
  __m128 mc0 = _mm_loadu_ps(&c0.r);
...
inline color_rgba32f lerp(const color_rgb32f& c0,
                          const color_rgb32f& c1,
                          const color_rgb32f& c2,
                          const color_rgb32f& c3,
                          float tx,
                          float ty) {
  ...
  return color_rgb32f(c01.r + (c23.r - c01.r) * ty,
                      c01.r + (c23.g - c01.g) * ty,
                      c01.r + (c23.b - c01.b) * ty)
      .to_rgba32f();
}
inline color_rgba32f lerp(const color_bgra8& c0,
                          const color_bgra8& c1,
                          const color_bgra8& c2,
                          const color_bgra8& c3,
                          float tx,
                          float ty) {
#ifndef EFLIB_NO_SIMD
  ...
  return ret;
#else
  color_rgba32f ret = lerp(color_rgba32f(c0.r, c0.g, c0.b, c0.a),
                           color_rgba32f(c1.r, c1.g, c1.b, c1.a),
                           color_rgba32f(c2.r, c2.g, c2.b, c2.a),
                           color_rgba32f(c3.r, c3.g, c3.b, c3.a),
                           tx,
                           ty);
  ret.get_vec4() /= 255.0f;
  return ret;
...
inline color_rgba32f lerp(const color_rgba8& c0,
                          const color_rgba8& c1,
                          const color_rgba8& c2,
                          const color_rgba8& c3,
                          float tx,
                          float ty) {
#ifndef EFLIB_NO_SIMD
  __m128i mzero = _mm_setzero_si128();
...
inline color_rgba32f lerp(const color_r32f& c0,
                          const color_r32f& c1,
                          const color_r32f& c2,
                          const color_r32f& c3,
                          float tx,
...
inline color_rgba32f lerp(const color_rg32f& c0,
                          const color_rg32f& c1,
                          const color_rg32f& c2,
                          const color_rg32f& c3,
                          float tx,
                          float ty) {
...
inline color_rgba32f lerp(const color_r32i& c0,
                          const color_r32i& c1,
                          const color_r32i& c2,
                          const color_r32i& c3,
                          float tx,

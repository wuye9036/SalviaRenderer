...
protected:
  swap_chain_impl(salviar::renderer_ptr const &renderer,
...
swap_chain_ptr create_gl_swap_chain(salviar::renderer_ptr const &renderer,
                                    salviar::renderer_parameters const *);
#endif

#if defined(SALVIAX_D3D11_ENABLED)
swap_chain_ptr create_d3d11_swap_chain(salviar::renderer_ptr const &renderer,
                                       salviar::renderer_parameters const *);
#endif

...
public:
  ...
  virtual void draw(std::string const &text, salviar::surface *target,
                    eflib::rect<int32_t> const &rc, salviar::color_rgba32f const &foreground_color,
                    salviar::color_rgba32f const &background_color, font::render_hints hint) = 0;
};

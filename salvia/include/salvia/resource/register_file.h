...
template <typename T>
struct vls_traits<
    T, typename std::enabled_if<std::is_base_of<salviar::register_file, T>::value>::type> {
  static bool const need_construct = false;
  static bool const need_destroy = false;

  static void construct(vls_allocator<salviar::register_file>::pointer p,
  ...
  static void destroy(vls_allocator<salviar::register_file>::pointer p,
                      vls_allocator<salviar::register_file>::size_type stride);
  static void copy(vls_allocator<salviar::register_file>::reference lhs,
                   vls_allocator<salviar::register_file>::size_type stride,

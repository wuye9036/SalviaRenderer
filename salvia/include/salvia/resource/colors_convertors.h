...
public:
  ...
  static pixel_lerp_1d get_lerp_1d_func(pixel_format infmt) { return lerpers_1d[infmt]; }
  static pixel_lerp_2d get_lerp_2d_func(pixel_format infmt) { return lerpers_2d[infmt]; }

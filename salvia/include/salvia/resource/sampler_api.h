...
void tex2Dgrad_ps(eflib::vec4* results,
                  uint32_t mask,
                  sampler* samp,
                  eflib::vec2* coords,
                  eflib::vec2 const* ddxs,
                  eflib::vec2 const* ddys);
void tex2Dbias_ps(eflib::vec4* results,
                  uint32_t mask,
                  sampler* samp,
                  eflib::vec4* coords,
                  eflib::vec2 const* ddxs,
...
void tex2Dproj_ps(eflib::vec4* results,
                  uint32_t mask,
                  sampler* samp,
                  eflib::vec4* coords,
                  eflib::vec4 const* ddxs,
                  eflib::vec4 const* ddys);

...
private:
  ...
  void draw_partial_tile(int left, int top, const eflib::vec4 *edge_factors,
                         drawing_shader_context const *shaders,
                         drawing_triangle_context const *triangle_ctx);
  void subdivide_tile(int left, int top, const eflib::rect<uint32_t> &cur_region,
                      const eflib::vec4 *edge_factors, uint32_t *test_regions,
  ...
  void draw_full_quad(uint32_t left, uint32_t top, drawing_shader_context const *shaders,
                      drawing_triangle_context const *triangle_ctx);
  void draw_quad(uint32_t left, uint32_t top, uint64_t quad_mask,
                 drawing_shader_context const *shaders,
                 drawing_triangle_context const *triangle_ctx);

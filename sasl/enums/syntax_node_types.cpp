...
const syntax_node_types syntax_node_types::qualified_type ( 281479271677954 );
...
public:
	dict_wrapper_syntax_node_types(){
		...
		enum_to_name.insert( std::make_pair( syntax_node_types::qualified_type, "qualified_type" ) );
		...
		name_to_enum.insert( std::make_pair( "qualified_type", syntax_node_types::qualified_type ) );

...
public:
	...
	unary_intrin_functor	bind_cast_sv(llvm::Type* elem_ty, cast_ops op);
	...
	llvm::Function* intrin(int intrin_id);
	llvm::Function* intrin(int intrin_id, llvm::FunctionType* ty);
	template <typename FunctionT>
	llvm::Function* intrin( int intrin_id )
	{
		return intrin( intrin_id, llvm::TypeBuilder<FunctionT, false>::get(context_) );
	}
	...
	llvm::Value* cast_sv(llvm::Value* v, llvm::Type* ty, cast_ops op);
...
private:
	...
	llvm::Function*			externals_[externals_count];

...
class cg_extension {
public:
  cg_extension(llvm::DefaultIRBuilder* builder,
  ...
  llvm::Value* call_binary_intrin_mono(llvm::Type* ret_ty,
                                       llvm::Value* lhs,
                                       llvm::Value* rhs,
                                       binary_intrin_functor sv_fn,
                                       unary_intrin_functor cast_result_sv_fn);
  value_array call_binary_intrin(llvm::Type* ret_ty,
  ...
  value_array
  call_unary_intrin(llvm::Type* ret_ty, value_array const& v, unary_intrin_functor sv_fn);
  ...
  unary_intrin_functor promote_to_unary_sv(unary_intrin_functor sfn,
                                           unary_intrin_functor vfn,
                                           unary_intrin_functor simd_fn);
  binary_intrin_functor promote_to_binary_sv(binary_intrin_functor sfn,
...
private:
  ...
  llvm::Value* promote_to_unary_sv_impl(llvm::Value* v,
                                        unary_intrin_functor sfn,
                                        unary_intrin_functor vfn,
                                        unary_intrin_functor simd_fn);
  llvm::Value* promote_to_binary_sv_impl(llvm::Value* lhs,
                                         llvm::Value* rhs,

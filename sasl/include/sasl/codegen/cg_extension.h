...
namespace cast_ops {
enum id { unknown, f2u, f2i, u2f, i2f, bitcast, i2i_signed, i2i_unsigned };
}
...
public:
  ...
  llvm::Value *call_binary_intrin_mono(llvm::Type *ret_ty, llvm::Value *lhs, llvm::Value *rhs,
                                       binary_intrin_functor sv_fn,
                                       unary_intrin_functor cast_result_sv_fn);
  value_array call_binary_intrin(llvm::Type *ret_ty, value_array const &lhs, value_array const &rhs,
                                 binary_intrin_functor sv_fn,
                                 unary_intrin_functor cast_result_sv_fn);

  // Scalar, vector and aggregated type could be used as type of lhs and rhs.
  llvm::Value *call_unary_intrin(llvm::Type *ret_ty, llvm::Value *v, unary_intrin_functor sv_fn);
  value_array call_unary_intrin(llvm::Type *ret_ty, value_array const &v,
  ...
  unary_intrin_functor promote_to_unary_sv(unary_intrin_functor sfn, unary_intrin_functor vfn,
                                           unary_intrin_functor simd_fn);
  binary_intrin_functor promote_to_binary_sv(binary_intrin_functor sfn, binary_intrin_functor vfn,
...
private:
  ...
  llvm::Value *promote_to_unary_sv_impl(llvm::Value *v, unary_intrin_functor sfn,
                                        unary_intrin_functor vfn, unary_intrin_functor simd_fn);
  llvm::Value *promote_to_binary_sv_impl(llvm::Value *lhs, llvm::Value *rhs,
                                         binary_intrin_functor sfn, binary_intrin_functor vfn,
                                         binary_intrin_functor simd_fn);

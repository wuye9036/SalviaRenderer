...
class module_vmcode {
public:
  virtual sasl::semantic::module_semantic* get_semantic() const = 0;
  virtual sasl::codegen::module_context* get_context() const = 0;

  virtual llvm::Module* get_vm_module() const = 0;
  virtual llvm::LLVMContext& get_vm_context() = 0;
...
module_vmcode_ptr generate_vmcode(sasl::semantic::module_semantic_ptr const&,

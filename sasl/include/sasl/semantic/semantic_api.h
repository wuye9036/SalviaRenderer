...
module_semantic_ptr
analysis_semantic(sasl::syntax_tree::node_ptr const& root, sasl::common::diag_chat*, uint32_t lang);
module_semantic_ptr
analysis_semantic(sasl::syntax_tree::node* root, sasl::common::diag_chat*, uint32_t lang);

...
public:
	...
	symbol_array find_overloads(std::string_view name, caster_t* conv, expression_array const& args) const;
	symbol_array find_assign_overloads(std::string_view name, caster_t* conv, expression_array const& args) const;
...
private:
	...
	static symbol* create(module_semantic* owner, symbol* parent, node* assoc_node, std::string_view mangled);
	
	symbol(module_semantic* owner, symbol* parent, node* assoc_node, eflib::fixed_string const* mangled);

	symbol_array find_overloads_impl(std::string_view name, caster_t* conv, expression_array const& args) const;

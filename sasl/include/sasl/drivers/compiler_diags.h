...
constexpr diag_template unknown_detail_level{
    3001, diag_levels::info, "Detail Level '{}' is invalid and was ignored."};
constexpr diag_template input_file_is_missing{
    3002,
    diag_levels::fatal_error,
    "Input File is missing. Please specify input file at least one."};

...
public:
  vx_shader_unit_impl(ia_shim_func_ptr shim_func, shader_func_ptr shader_func, void const *cbuffer,
                      shims::ia_shim_data const *data, size_t istr_size, size_t obuf_size,
                      size_t ostr_size, vso2reg_func_ptr vso2reg_func, uint32_t vso_attrs_count,
                      intptr_t const *vso_attr_offsets, uint32_t const *vso_attr_types);

...
struct expression_initializer: public node_impl<expression_initializer, initializer, node_ids::expression_initializer> {
  std::shared_ptr<expression> init_expr;
};

struct member_initializer: public node_impl<member_initializer, initializer, node_ids::member_initializer> {
...
struct variable_declaration: public node_impl<variable_declaration, declaration, node_ids::variable_declaration> {
  std::shared_ptr<tynode> type_info;
  std::vector<std::shared_ptr<declarator>> declarators;
};

struct type_definition: public node_impl<type_definition, declaration, node_ids::typedef_definition> {
  std::shared_ptr<tynode> type_info;
  token name;
};
...
struct function_full_def: public node_impl<function_full_def, tynode, node_ids::function_full_def> {
  token  name;
...
struct null_declaration: public node_impl<null_declaration, declaration, node_ids::null_declaration> {
};
} // namespace sasl::syntax_tree

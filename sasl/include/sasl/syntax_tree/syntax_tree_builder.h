...
public:
  ...
  void build_struct_body(std::shared_ptr<sasl::parser::attribute> attr,
                         std::shared_ptr<struct_type> out);
  ...
  std::shared_ptr<cast_expression>
  build_typecastedexpr(std::shared_ptr<sasl::parser::attribute> attr);
  std::shared_ptr<unary_expression>
  build_unariedexpr(std::shared_ptr<sasl::parser::attribute> attr);
  std::shared_ptr<expression> build_postexpr(std::shared_ptr<sasl::parser::attribute> attr);
  std::shared_ptr<expression> build_callexpr(std::shared_ptr<sasl::parser::attribute> attr,
                                             std::shared_ptr<expression> expr);
  std::shared_ptr<expression> build_indexexpr(std::shared_ptr<sasl::parser::attribute> attr,
                                              std::shared_ptr<expression> expr);
  std::shared_ptr<expression> build_memexpr(std::shared_ptr<sasl::parser::attribute> attr,
                                            std::shared_ptr<expression> expr);
  ...
  std::shared_ptr<compound_statement>
  build_stmt_compound(std::shared_ptr<sasl::parser::attribute> attr);
  std::shared_ptr<jump_statement> build_flowctrl(std::shared_ptr<sasl::parser::attribute> attr);
  std::shared_ptr<expression_statement>
  build_stmt_expr(std::shared_ptr<sasl::parser::attribute> attr);
  std::shared_ptr<declaration_statement>
  build_stmt_decl(std::shared_ptr<sasl::parser::attribute> attr);
  ...
  std::shared_ptr<dowhile_statement>
  build_stmt_dowhile(std::shared_ptr<sasl::parser::attribute> attr);
  std::shared_ptr<switch_statement>
  build_stmt_switch(std::shared_ptr<sasl::parser::attribute> attr);
  ...
  std::shared_ptr<tynode> bind_typequal(std::shared_ptr<tynode> unqual,

...
set( 3rd_party_llvm_include_path
	"${3rd_party_llvm_path}/include/" "${3rd_party_llvm_path}/config/${SASL_ENV_WITHOUT_BUILD_TYPE}/"
	)
set( 3rd_party_llvm_lib_path "${3rd_party_llvm_path}/lib/${SASL_ENVIRONMENT_NAME}/" )
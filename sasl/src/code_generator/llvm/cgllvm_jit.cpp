...
boost::shared_ptr<cgllvm_jit_engine> cgllvm_jit_engine::create( boost::shared_ptr<cgllvm_gmod> ctxt, std::string& error ){
...
cgllvm_jit_engine::cgllvm_jit_engine( boost::shared_ptr<cgllvm_gmod> ctxt )

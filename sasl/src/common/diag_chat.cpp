...
void diag_chat::report_impl(diag_template tmpl, std::string_view file_name, code_span span,
...
void diag_chat::report(diag_template tmpl, token token_beg, token token_end) {
...
void diag_chat::clear() { diags_.clear(); }

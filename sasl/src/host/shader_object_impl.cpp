...
shader_object_impl::shader_object_impl() : entry_(nullptr) {}

shader_reflection const *shader_object_impl::get_reflection() const { return reflection_.get(); }
...
void shader_object_impl::set_vm_code(module_vmcode_ptr const &vmcode) { module_vmc_ = vmcode; }

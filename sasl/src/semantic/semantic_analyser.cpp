...
SASL_VISIT_DEF(unary_expression) {
  ...
  if (v.op == operators::prefix_incr || v.op == operators::postfix_incr ||
...
SASL_VISIT_DEF(index_expression) {
  ...
  shared_ptr<index_expression> dup_idxexpr =
      duplicate(v.as_handle())->as_handle<index_expression>();
  ...
  if (agg_tyn->is_array()) {
    ...
    tid_t inner_tid =
        module_semantic_->pety()->get_array(elem_tid, array_tyn->array_lens.size() - 1);
...
SASL_VISIT_DEF(expression_initializer) {
  ...
  shared_ptr<expression_initializer> dup_exprinit =
      duplicate(v.as_handle())->as_handle<expression_initializer>();
...
SASL_VISIT_DEF(variable_declaration) {
  ...
  shared_ptr<variable_declaration> dup_vdecl =
      duplicate(v.as_handle())->as_handle<variable_declaration>();
...
SASL_VISIT_DEF(struct_type) {
  ...
  tid_t dup_struct_id = module_semantic_->pety()->get(&v, current_symbol);
...
SASL_VISIT_DEF(parameter_full) {
  ...
  if (v.init) {
    dup_par->init = visit_child(v.init);
  }
...
SASL_VISIT_DEF(function_full_def) {
  ...
  shared_ptr<function_def> def_node = create_node<function_def>(v.token_begin(), v.token_end());
...
SASL_VISIT_DEF(declaration_statement) {
  ...
  shared_ptr<declaration_statement> dup_declstmt =
...
SASL_VISIT_DEF(dowhile_statement) {
  ...
  shared_ptr<dowhile_statement> dup_dowhile =
      duplicate(v.as_handle())->as_handle<dowhile_statement>();
...
SASL_VISIT_DEF(labeled_statement) {
  ...
  shared_ptr<labeled_statement> dup_lbl_stmt =
      duplicate(v.as_handle())->as_handle<labeled_statement>();
...
SASL_VISIT_DEF(compound_statement) {
  ...
  shared_ptr<compound_statement> dup_stmt =
      duplicate(v.as_handle())->as_handle<compound_statement>();
  dup_stmt->stmts.clear();

  SYMBOL_SCOPE(current_symbol->add_child(dup_stmt.get()));

  for (vector<shared_ptr<statement>>::iterator it = v.stmts.begin(); it != v.stmts.end(); ++it) {
...
SASL_VISIT_DEF(expression_statement) {
  ...
  shared_ptr<expression_statement> dup_exprstmt =
      duplicate(v.as_handle())->as_handle<expression_statement>();
...
SASL_VISIT_DEF(program) {
  ...
  initialize_casts();
  caster->set_function_get_tynode(
      [this](tid_t tid) { return module_semantic_->pety()->get_proto(tid); });
  ...
  module_semantic_->set_language(static_cast<salvia::shader::languages>(lang));
...
void semantic_analyser::initialize_operator_parameter_lrvs() {
  ...
  // Binary operators
  operator_parameter_lrvs_.insert(
      make_pair(operators::add, parameter_lrvs(rvalue, rvalue, rvalue)));
  operator_parameter_lrvs_.insert(
      make_pair(operators::sub, parameter_lrvs(rvalue, rvalue, rvalue)));
  operator_parameter_lrvs_.insert(
      make_pair(operators::mul, parameter_lrvs(rvalue, rvalue, rvalue)));
  operator_parameter_lrvs_.insert(
      make_pair(operators::div, parameter_lrvs(rvalue, rvalue, rvalue)));
  operator_parameter_lrvs_.insert(
      make_pair(operators::mod, parameter_lrvs(rvalue, rvalue, rvalue)));

  operator_parameter_lrvs_.insert(
      make_pair(operators::bit_and, parameter_lrvs(rvalue, rvalue, rvalue)));
  operator_parameter_lrvs_.insert(
      make_pair(operators::bit_or, parameter_lrvs(rvalue, rvalue, rvalue)));
  operator_parameter_lrvs_.insert(
      make_pair(operators::bit_xor, parameter_lrvs(rvalue, rvalue, rvalue)));

  operator_parameter_lrvs_.insert(
      make_pair(operators::logic_and, parameter_lrvs(rvalue, rvalue, rvalue)));
  operator_parameter_lrvs_.insert(
      make_pair(operators::logic_or, parameter_lrvs(rvalue, rvalue, rvalue)));

  operator_parameter_lrvs_.insert(
      make_pair(operators::left_shift, parameter_lrvs(rvalue, rvalue, rvalue)));
  operator_parameter_lrvs_.insert(
      make_pair(operators::right_shift, parameter_lrvs(rvalue, rvalue, rvalue)));

  operator_parameter_lrvs_.insert(
      make_pair(operators::less, parameter_lrvs(rvalue, rvalue, rvalue)));
  operator_parameter_lrvs_.insert(
      make_pair(operators::less_equal, parameter_lrvs(rvalue, rvalue, rvalue)));
  operator_parameter_lrvs_.insert(
      make_pair(operators::equal, parameter_lrvs(rvalue, rvalue, rvalue)));
  operator_parameter_lrvs_.insert(
      make_pair(operators::greater_equal, parameter_lrvs(rvalue, rvalue, rvalue)));
  operator_parameter_lrvs_.insert(
      make_pair(operators::greater, parameter_lrvs(rvalue, rvalue, rvalue)));
  operator_parameter_lrvs_.insert(
      make_pair(operators::not_equal, parameter_lrvs(rvalue, rvalue, rvalue)));

  // Assigns
  operator_parameter_lrvs_.insert(
      make_pair(operators::assign, parameter_lrvs(lvalue, rvalue, lvalue)));

  operator_parameter_lrvs_.insert(
      make_pair(operators::add_assign, parameter_lrvs(lvalue, rvalue, lvalue)));
  operator_parameter_lrvs_.insert(
      make_pair(operators::sub_assign, parameter_lrvs(lvalue, rvalue, lvalue)));
  operator_parameter_lrvs_.insert(
      make_pair(operators::mul_assign, parameter_lrvs(lvalue, rvalue, lvalue)));
  operator_parameter_lrvs_.insert(
      make_pair(operators::div_assign, parameter_lrvs(lvalue, rvalue, lvalue)));
  operator_parameter_lrvs_.insert(
      make_pair(operators::mod_assign, parameter_lrvs(lvalue, rvalue, lvalue)));

  operator_parameter_lrvs_.insert(
      make_pair(operators::bit_and_assign, parameter_lrvs(lvalue, rvalue, lvalue)));
  operator_parameter_lrvs_.insert(
      make_pair(operators::bit_or_assign, parameter_lrvs(lvalue, rvalue, lvalue)));
  operator_parameter_lrvs_.insert(
      make_pair(operators::bit_xor_assign, parameter_lrvs(lvalue, rvalue, lvalue)));

  operator_parameter_lrvs_.insert(
      make_pair(operators::lshift_assign, parameter_lrvs(lvalue, rvalue, lvalue)));
  operator_parameter_lrvs_.insert(
      make_pair(operators::rshift_assign, parameter_lrvs(lvalue, rvalue, lvalue)));
  ...
  operator_parameter_lrvs_.insert(
      make_pair(operators::prefix_incr, parameter_lrvs(lvalue, lvalue)));
  operator_parameter_lrvs_.insert(
      make_pair(operators::prefix_decr, parameter_lrvs(lvalue, lvalue)));

  operator_parameter_lrvs_.insert(
      make_pair(operators::postfix_incr, parameter_lrvs(rvalue, lvalue)));
  operator_parameter_lrvs_.insert(
      make_pair(operators::postfix_decr, parameter_lrvs(rvalue, lvalue)));
}
...
void semantic_analyser::register_builtin_functions2() {
  ...
  // Function groups
  vector<string_view> vf_vf_intrin_names{"degrees"sv,  "radians"sv, "sqrt"sv,  "exp"sv,   "exp2"sv,
                                         "sin"sv,      "cos"sv,     "tan"sv,   "asin"sv,  "acos"sv,
                                         "atan"sv,     "ceil"sv,    "floor"sv, "log"sv,   "log2"sv,
                                         "log10"sv,    "sinh"sv,    "cosh"sv,  "tanh"sv,  "frac"sv,
                                         "saturate"sv, "round"sv,   "trunc"sv, "rsqrt"sv, "rcp"sv};

  vector<string_view> vf_vfvf_intrin_names{"fmod"sv, "ldexp"sv, "pow"sv, "step"sv};

  vector<string_view> vf_vfvfvf_intrin_names{"lerp"sv, "smoothstep"sv};
  ...
  // Register functions with share-less signatures
  {
    ...
    for (size_t vec_size = 1; vec_size <= 4; ++vec_size) {
      ...
      for (size_t vec_cnt = 1; vec_cnt <= 4; ++vec_cnt) {
        float_matrix_tids[vec_size][vec_cnt] =
            pety->get(matrix_of(builtin_types::_float, vec_size, vec_cnt));
      }
    }
    ...
    for (size_t i = 1; i <= 4; ++i) {
      norm_fns.push_back(protos.add_proto(fvec_tids[i]).result(fvec_tids[i]));
      length_fns.push_back(protos.add_proto(fvec_tids[i]).result(float_tid));
      dist_dot_fns.push_back(protos.add_proto(fvec_tids[i], fvec_tids[i]).result(float_tid));
      reflect_fns.push_back(protos.add_proto(fvec_tids[i], fvec_tids[i]).result(fvec_tids[i]));
    ...
    dst_fns.push_back(protos.add_proto(fvec_tids[4], fvec_tids[4]).result(fvec_tids[4]));
    register_intrinsic2("dst", dst_fns, protos.protos());

    vector<size_t> cross_fns;
    cross_fns.push_back(protos.add_proto(fvec_tids[3], fvec_tids[3]).result(fvec_tids[3]));
    register_intrinsic2("cross", cross_fns, protos.protos());

    vector<size_t> lit_fns;
    lit_fns.push_back(protos.add_proto(float_tid, float_tid, float_tid).result(fvec_tids[4]));
    ...
    if (lang == salvia::shader::lang_pixel_shader || lang == salvia::shader::lang_vertex_shader) {
      ...
      if (lang == salvia::shader::lang_pixel_shader) {
        ...
        tex_fns[0] = protos.add_proto(sampler_tid, fvec_tids[2], fvec_tids[2], fvec_tids[2])
                         .result(fvec_tids[4]);
    ...
    for (size_t vec_size = 1; vec_size <= 4; ++vec_size) {
      for (size_t vec_cnt = 1; vec_cnt <= 4; ++vec_cnt) {
        mul_fns.push_back(protos.add_proto(fvec_tids[vec_cnt], float_matrix_tids[vec_size][vec_cnt])
  ...
  // Register constructors
  {
    ...
    for (size_t i_scalar = 0; i_scalar < scalar_bts.size(); ++i_scalar) {
      ...
      for (size_t scalar_count = 2; scalar_count <= 4; ++scalar_count) {
        ...
        string_view fs_contructor_name(std::move(constructor_name));

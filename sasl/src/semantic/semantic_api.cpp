...
shared_ptr<module_si> analysis_semantic( shared_ptr<node> const& root, diag_chat* diags, uint32_t lang ){
...
shared_ptr<module_si> analysis_semantic( node* root, diag_chat* diags, uint32_t lang )
{

...
options_display_info::options_display_info() : show_help(false), show_version(false) {}

void options_display_info::fill_desc(po::options_description &desc) {
  desc.add_options()(help_tag, help_desc)(version_tag, version_desc);
  pdesc = &desc;
}
...
const char *options_io::export_as_desc =
    "Specifies the content of output file that the compiler should generate.";

const char *options_io::lang_tag = "lang";
const char *options_io::lang_desc = "Specifies language the input file was treated "
...
void options_io::fill_desc(po::options_description &desc) {
  desc.add_options()(in_tag, po::value<string>(&input_file),
                     in_desc)(out_tag, po::value<string>(&output_file_name),
                              out_desc)(dump_ir_tag, po::value<string>(&dump_ir), dump_ir_desc)(
      export_as_tag, po::value<string>(&fmt_str),
...
void options_global::fill_desc(po::options_description &desc) {
  desc.add_options()("detail-level", po::value<string>(&detail_str),
...
option_macros::option_macros() { return; }

void option_macros::fill_desc(po::options_description &desc) {
  desc.add_options()(define_tag, po::value<vector<string>>(&defines)->composing(), define_desc)(
      predef_tag, po::value<vector<string>>(&predefs)->composing(),

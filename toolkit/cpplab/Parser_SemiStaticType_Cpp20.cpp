...
public:
    ...
    struct _model final: _concept {
        ...
        _model(Visitor& visitor, AttrValue2&& value): visitor(visitor), attr_value{((AttrValue2&&)value)} {
        }
        void accept() override {
            visitor(Rule{}, attr_value);
        }
        Visitor& visitor;
    ...
    template <typename Visitor, typename Rule, typename AttrValue>
    attribute(Visitor& visitor, Rule, AttrValue&& value): attr_impl_{

...
SASL_PROCESSOR_IMPL_CONVERT_PARAMETER_TO_VALUE_REFERENCE( vm, (mul,  gr,  raw, gr, raw) )
SASL_PROCESSOR_IMPL_CONVERT_PARAMETER_TO_VALUE_REFERENCE( vm, (div,  gr,  raw, gr, raw) )

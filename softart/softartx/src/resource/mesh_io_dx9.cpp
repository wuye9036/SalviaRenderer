...
h_mesh create_mesh_from_xfile(renderer_impl* psr, const _tstring& filename)
{
	...
	HRESULT result = D3DXLoadMeshFromX(filename.c_str(), D3DXMESH_SYSTEMMEM, pdev, &padjbuf, &pmaterials, &peffectinstances, &material_counts, &pmesh);

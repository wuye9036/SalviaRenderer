...
public:
	...
	void clip(std::vector<vs_output> &out_clipped_verts, const vs_output& v0, const vs_output& v1) const;
	void clip(std::vector<vs_output> &out_clipped_verts, const vs_output& v0, const vs_output& v1, const vs_output& v2) const;
